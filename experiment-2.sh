    ...
    do
        ...
        do
            ...
            then
                ...
                ./main.py --tag experiment2-$seed-$optim-$lr --seed $seed --num-shards 3 --epochs 500 train --dataset elman-xor --stages 3 --optimizer $optim --learning-rate $lr --sentence-length 3 --batch-size 4
                touch "$DONEFILE"
                sync
                sleep 1
                rm "$LOCKFILE"
